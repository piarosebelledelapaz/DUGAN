...
class DUGAN(TrainTask):
    ...
    def set_model(self):
        ...
        self.img_discriminator = img_discriminator.to(device)
        self.img_d_optimizer = img_d_optimizer
        self.grad_discriminator = grad_discriminator.to(device)

        self.ema_generator = ema_generator.to(device)
    ...
    def train(self, inputs, n_iter):
        ...
        low_dose, full_dose = low_dose.to(device), full_dose.to(device)
